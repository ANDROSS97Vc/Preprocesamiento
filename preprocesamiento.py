...
ruta_carga = '/content/drive/MyDrive/dataset/dataset_preprocesado_completo.csv'
...
print(f"Tamaño de los datos de entrenamiento: {X_train.shape[0]} registros")
print(f"Tamaño de los datos de prueba: {X_test.shape[0]} registros")
...
print("\n--- 📝 Metricas del modelo con threshold ajustado ---")
...
df_matriz = pd.DataFrame(
    ...
    columns=['Prediccion: No ECV (0)', 'Prediccion: Si ECV (1)']
)
...
plt.title("Curva ROC - Datos Preprocesados (One-Hot)")
plt.show()