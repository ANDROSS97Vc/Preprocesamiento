...
6. Integración de todas las transformaciones
...
Una vez transformadas todas las variables, se construye un nuevo DataFrame que contiene únicamente las características procesadas. A este conjunto final se le agrega nuevamente la columna “cardio” como variable objetivo.
Posteriormente, el archivo resultante se guarda con el nombre dataset_preprocesado_completo.csv.

8. Exportación y descarga
